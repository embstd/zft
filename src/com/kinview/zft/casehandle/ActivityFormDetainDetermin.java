...
public class ActivityFormDetainDetermin extends TabActivity {
	...
	private Class[] tabClass = {ActivityFormDetainDeterminReg.class, ActivityFormDetainDeterminInfoListView.class};
