...
//行政处罚决定书
public class ActivityFormPublishDetermin extends TabActivity {
	...
	private Class[] tabClass = {ActivityFormPublishDeterminInfo.class, ActivityFormPublishDeterminSituation.class};
