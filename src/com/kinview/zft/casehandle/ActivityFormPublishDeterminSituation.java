...
public class ActivityFormPublishDeterminSituation extends Activity{
...
//		caseId = intent.getIntExtra("caseId", 0);
		...
		reportCase.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Dialog.showDialog(Dialog.OKCANCEL, ActivityFormPublishDeterminSituation.this, myHandler, Msg.PROMPT_PRINT,
...
//		et_site_publish_determin_4.setText(Config.currentNewCaseList.get(0).getFazhe());//违法证据
		et_site_publish_determin_5.setText(Config.currentNewCaseList.get(0).getFazhe());
		et_site_publish_determin_6.setText(Config.currentNewCaseList.get(0).getYiju());
...
//				refresh();
			...
			case Msg.ERROR_SERVER_CONNECT:
				Dialog.showDialog(Dialog.OKCANCEL, ActivityFormPublishDeterminSituation.this,
						null, Msg.PROGRAM_EXIT, "连接", "服务器连接失败,请稍后重试", 0, "");
				break;
			case Msg.PROGRAM_EXIT:
				ThreadExit thread = new ThreadExit(ActivityFormPublishDeterminSituation.this);
				thread.showProcess();
				break;
			...
			case Msg.TITLE_PROGRESS_STOP:
				...
				break;
			case Msg.ONBACK:
				it = new Intent(ActivityFormPublishDeterminSituation.this,ActivityFormList.class);
				b = new Bundle ();
			...
			case Msg.REQUEST_SUCCESS:
				Dialog.showDialog(Dialog.OK, ActivityFormPublishDeterminSituation.this,
	...
	private void init(){
		...
		tv_site_publish_determin_4.setText("违法证据：");
		tv_site_publish_determin_5.setText("违法规定：");
		tv_site_publish_determin_6.setText("处罚依据：");
		
		tv_site_publish_determin_7.setVisibility(View.GONE);
		tv_site_publish_determin_8.setVisibility(View.GONE);
		tv_site_publish_determin_9.setVisibility(View.GONE);
		tv_site_publish_determin_10.setVisibility(View.GONE);
		tv_site_publish_determin_11.setVisibility(View.GONE);
		et_site_publish_determin_7.setVisibility(View.GONE);
		et_site_publish_determin_8.setVisibility(View.GONE);
		et_site_publish_determin_9.setVisibility(View.GONE);
		et_site_publish_determin_10.setVisibility(View.GONE);
		et_site_publish_determin_11.setVisibility(View.GONE);
...
//		.append(et_site_publish_determin_9.getText().toString().trim().replaceAll("_", "")).append("_")
//		.append(et_site_publish_determin_10.getText().toString().trim().replaceAll("_", "")).append("_")
		.append(et_site_publish_determin_6.getText().toString().trim().replaceAll("_", ""));
		return content.toString();
//		return Html.fromHtml(content.toString()).toString();
	}
	...
	private void posPrintProcess() {
		if (checkInputLegal()) {
			Intent it  = new Intent(ActivityFormPublishDeterminSituation.this, ActivityPosPrint.class);
