...
//证人证言笔录
public class ActivityFormWitnessRecored extends TabActivity {
	...
	public static final String SECOND = "证言内容";
	
	private String[] tabCategory = {FIRST, SECOND};
	private Class[] tabClass = {ActivityFormWitnessRecoredBaseInfo.class, ActivityFormWitnessRecoredOtherInfo.class};
