...
public class ActivityFormEvidenceInfoListView extends Activity {
...
//		});
		...
		reportCase.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Dialog.showDialog(Dialog.OKCANCEL, ActivityFormEvidenceInfoListView.this, myHandler, Msg.PROMPT_PRINT,
...
//		int bd_id = Config.currentFormList.get(position).getId();
		...
		it = new Intent(ActivityFormEvidenceInfoListView.this, ActivityFormEvidenceInfo.class);
		Bundle b = new Bundle();
...
//				refresh();
			...
			case Msg.ERROR_SERVER_CONNECT:
				Dialog.showDialog(Dialog.OKCANCEL, ActivityFormEvidenceInfoListView.this,
						null, Msg.PROGRAM_EXIT, "连接", "服务器连接失败,请稍后重试", 0, "");
				break;
			case Msg.PROGRAM_EXIT:
				ThreadExit thread = new ThreadExit(ActivityFormEvidenceInfoListView.this);
				thread.showProcess();
				break;
			...
			case Msg.TITLE_PROGRESS_STOP:
				...
				break;
			case Msg.ONBACK:
				it = new Intent(ActivityFormEvidenceInfoListView.this,ActivityFormList.class);
				b = new Bundle ();
			...
			case Msg.REQUEST_SUCCESS:
				Dialog.showDialog(Dialog.OK, ActivityFormEvidenceInfoListView.this,
...
//		return Html.fromHtml(content.toString()).toString();
	...
	private void posPrintProcess() {
		if (checkInputLegal()) {
			Intent it  = new Intent(ActivityFormEvidenceInfoListView.this, ActivityPosPrint.class);
