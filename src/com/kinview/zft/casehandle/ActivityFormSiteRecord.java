...
public class ActivityFormSiteRecord extends TabActivity {
	...
	public static final String SECOND = "记录情况";
	
	private String[] tabCategory = {FIRST, SECOND};
	private Class[] tabClass = {ActivityFormSiteRecordInfo.class, ActivityFormSiteRecordSituation.class};
