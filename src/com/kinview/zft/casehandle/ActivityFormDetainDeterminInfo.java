...
public class ActivityFormDetainDeterminInfo extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		reportCase.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Dialog.showDialog(Dialog.OKCANCEL, ActivityFormDetainDeterminInfo.this, myHandler, Msg.PROMPT_PRINT,
...
//		}
		...
		saveButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Dialog.showDialog(Dialog.OK, ActivityFormDetainDeterminInfo.this,
...
//				refresh();
			...
			case Msg.ERROR_SERVER_CONNECT:
				Dialog.showDialog(Dialog.OKCANCEL, ActivityFormDetainDeterminInfo.this,
						null, Msg.PROGRAM_EXIT, "连接", "服务器连接失败,请稍后重试", 0, "");
				break;
			case Msg.PROGRAM_EXIT:
				ThreadExit thread = new ThreadExit(ActivityFormDetainDeterminInfo.this);
				thread.showProcess();
				break;
...
//				break;
			case Msg.ACTIVITY_EXIT:
				it = new Intent(ActivityFormDetainDeterminInfo.this,ActivityFormEvidenceInfoListView.class);
				b = new Bundle ();
...
//		Config.otherTabBdContent = getFormContentWhenPause();
	...
	private String getFormContent(){
		...
		content.append(Config.posFormTitle +"执扣字[").append(String.valueOf(year)).append("]  \r\nNo.")
...
//		return Html.fromHtml(content.toString()).toString();
	...
	private void posPrintProcess() {
		if (checkInputLegal()) {
			Intent it  = new Intent(ActivityFormDetainDeterminInfo.this, ActivityPosPrint.class);
