...
//当场处罚决定书
public class ActivityFormSitePublishDetermin extends TabActivity {
	...
	public static final String FIRST = "当事人信息";
	public static final String SECOND = "违法处罚";
	
	private String[] tabCategory = {FIRST, SECOND};
	private Class[] tabClass = {ActivityFormSitePublishDeterminInfo.class, ActivityFormSitePublishDeterminSituation.class};
